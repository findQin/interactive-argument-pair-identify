    ...
    def train(self):
        ...
        for epoch, _ in enumerate( trange_obj ):
            ...
            for step, batch in enumerate( tqdm_obj ):
                ...
                input_ids, segment_ids, input_mask, label_ids, sc_len, bc_len = batch

                logits = self.model(input_ids, segment_ids, input_mask, sc_len, bc_len)  
                ...
                logits_adv = self.model(input_ids, segment_ids, input_mask, sc_len, bc_len)
...
def main(config_file='config/bert_config.json'):
    ...
    print("config.batch_size:{}".format(config.batch_size))
